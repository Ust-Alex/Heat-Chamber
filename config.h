...
// ============================================================================
// ⚠️ ИЗМЕНЕНЫ для более плавной работы и устранения перескоков
#define PID_KP            0.8   // Уменьшена пропорциональная составляющая
#define PID_KI            0.2   // Сильно уменьшена интегральная (чтобы не копил лишнего)
#define PID_KD            0.5   // Уменьшена дифференциальная (чтобы не дёргался от шума)
