...
#define DEBUG_HEATER      0   // ВКЛЮЧЕНО для анализа работы ПИД
#define DEBUG_WEB         0   // Отладка веб-сервера (JSON, клиенты)
#define DEBUG_NTP         0   // Отладка синхронизации времени

// ============================================================================
// НАСТРОЙКИ OTA И WEBSERIAL
// ============================================================================
#define DEBUG_OTA         0   // Отладка OTA (0 - отключено, 1 - включено)
#define DEBUG_WEBSERIAL   0   // Отладка WebSerial (0 - отключено, 1 - включено)
